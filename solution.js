window.onload = function() {
        // Prompt for the first player's name
        p1_name = prompt("Enter the name of the first player:");
        p2_name = prompt("Enter the name of the second player:");

      
    };
let p1_name,p1_score;
function getPokemon(){
